...
mongoose.connect("mongodb+srv://nishant0708:jhn14300@cluster0.jd1ek1x.mongodb.net/e-commerce");
...
app.post("/upload",upload.single('product'),(req,res)=>{
    res.json({
        success:1,
        image_url:`https://ecom-kii2.onrender.com/images/${req.file.filename}`
    })
})
